...
RED_SPACE_SHIP = pygame.image.load(
    os.path.join(DIR, "pixel_ship_red_small.png"))
GREEN_SPACE_SHIP = pygame.image.load(
    os.path.join(DIR, "pixel_ship_green_small.png"))
BLUE_SPACE_SHIP = pygame.image.load(
    os.path.join(DIR, "pixel_ship_blue_small.png"))
YELLOW_SPACE_SHIP = pygame.image.load(
    os.path.join(DIR, "pixel_ship_yellow.png"))
...
BG = pygame.transform.scale(pygame.image.load(
    os.path.join(DIR, "background-black.png")), (WIDTH, HEIGHT))
...
def main():
    ...
    while run:
        ...
        if keys[pygame.K_w] and player.y - player_vel > 0:  # Up
            player.y -= player_vel
        if keys[pygame.K_s] and player.y + player_vel + player.getHeight() + 15 < HEIGHT:  # down
            player.y += player_vel
        ...
        if keys[pygame.K_UP] and player.y - player_vel > 0:  # Up
            player.y -= player_vel
        if keys[pygame.K_DOWN] and player.y + player_vel + player.getHeight() + 15 < HEIGHT:  # down
            player.y += player_vel
...
def mainMenu():
    ...
    while run:
        ...
        title_label = title_font.render(
            "Press any Mouse button to begin", 1, (255, 255, 255))
